...
transition_df = pd.DataFrame(transition_counts, index=[f"S{i}" for i in states], columns=[f"S{j}" for j in states])
...
plt.figure(figsize=(12, 8))
sns.heatmap(transition_df, annot=True, fmt='d', cmap='YlGnBu')
